...
type_token *getToken() {
    ...
    //Verifica aspas duplas
        ...
        //Implementar um buffer com capacidade maior (acima da 32 caracteres)=========================================================
        ...
        if(pos_buffer >= MAX_CHAR){
            //printf("[ERRO] Tamanho de buffer foi ultrapassado ou fechamento de aspas duplas não identificada.\n");
            token->tag = STRING;
            token->tag = ERROR;
            strcpy(token->lexema, buffer);
