...
//type_symbol_table_functions global_symbol_table_functions;
...
type_symbol_function *sym_func_declare(char *name, int type, type_symbol_table_entry *params[MAX_PARAMS],int nparams, char *func_label){
    ...
    strncpy (symfuncs[symfuncspos].label_comandos, func_label, MAX_TOKSZ);
...
// /**
//  * @brief Inicializa tabela de simbolos de funcoes globais
//  * 
//  * @param stv 
//  */
// void initSymbolTableFunctions(type_symbol_table_functions *stv) {
//     int i;
//     int t;
//     stv->n_functions = 0;
//     for (i = 0; i < MAX_FUNCS; i++) {
//         strcpy(stv->functions[i].name, "");
//         stv->functions[i].type = -1;
//         stv->functions[i].nparams = 0;
//     }
//     stv->next = NULL;
// }
